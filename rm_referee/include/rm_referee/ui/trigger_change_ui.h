...
{
public:
    explicit StepTriggerChangeUi(XmlRpc::XmlRpcValue& rpc_value, Base& base)
...
{
public:
    explicit DragTriggerChangeUi(XmlRpc::XmlRpcValue& rpc_value, Base& base)
...
{
public:
    explicit StoneTriggerChangeUi(XmlRpc::XmlRpcValue& rpc_value, Base& base)
